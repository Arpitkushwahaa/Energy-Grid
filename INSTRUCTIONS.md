# EnergyGrid Data Aggregator - Coding Assignment

## Objective
Build a robust client application (Node.js/Python/Go) to fetch real-time telemetry from 500 solar inverters, navigating strict rate limits and security protocols.
